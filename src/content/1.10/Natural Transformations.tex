...
is a function \code{f::a-\textgreater{}b}):
...
\code{a} and maps it into a function type \code{()-\textgreater{}a}.
...
\code{f\ ::\ c\ -\textgreater{}\ c\&apos;} and
\code{g\ ::\ d\ -\textgreater{}\ d\&apos;}. These pairs of morphisms
