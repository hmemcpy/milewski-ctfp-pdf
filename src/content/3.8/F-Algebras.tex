...
\code{m-\textgreater{}m}. As an example, integers form a group with
...
\code{F\ a\ -\textgreater{}\ a}, both from the original category
\emph{C}.
...
\code{j\ ::\ F\ i\ -\textgreater{}\ i}. It turns out that \code{j},
...
the morphism \code{u\ ::\ t\ -\textgreater{}\ F\ t} is an isomorphism
