...
There are two possible compositions, \code{R  \ensuremath{\circ} L} and
\code{L  \ensuremath{\circ} R}; and two possible identity functors: one in \emph{C}
...
\begin{Verbatim}[commandchars=\\\{\}]
R  \ensuremath{\circ} L = I\textsubscript{D}
\end{Verbatim}
or this one:

\begin{Verbatim}[commandchars=\\\{\}]
L  \ensuremath{\circ} R = I\textsubscript{C}
\end{Verbatim}
...
\code{R  \ensuremath{\circ} L} and the identity functor \code{I\textsubscript{D}}, and another
between \code{L  \ensuremath{\circ} R} and the identity functor \code{I\textsubscript{C}}.
...
way} natural transformation from \code{ID} to \code{R \ensuremath{\circ} L}, and
another from \code{L \ensuremath{\circ} R} to \code{IC}. Here are the signatures of
...
\begin{Verbatim}[commandchars=\\\{\}]
R  \ensuremath{\circ} L -> I\textsubscript{D} -- not necessarily
I\textsubscript{C} -> L  \ensuremath{\circ} R -- not necessarily
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
η\textsubscript{d} :: d -> (R  \ensuremath{\circ} L) d
\end{Verbatim}
Notice that the composition \code{R \ensuremath{\circ}L} is an endofunctor in \emph{D}.

This equation tells us that we can pick any object \code{d} in
\emph{D} as our starting point, and use the round trip functor
\code{R  \ensuremath{\circ} L} to pick our target object \code{d'}. Then we
...
\begin{Verbatim}[commandchars=\\\{\}]
ε\textsubscript{c'} :: (L  \ensuremath{\circ} R) c -> c
\end{Verbatim}
where \code{c'} is \code{(L  \ensuremath{\circ} R) c}. It tells us that we
can pick any object \code{c} in \emph{C} as our target, and use the
round trip functor \code{L  \ensuremath{\circ} R} to pick the source
...
\emph{introduce} the composition \code{R  \ensuremath{\circ} L} anywhere we could
insert an identity functor on \emph{D}; and counit lets us
\emph{eliminate} the composition \code{L  \ensuremath{\circ} R}, replacing it with the
...
\begin{Verbatim}[commandchars=\\\{\}]
L = L  \ensuremath{\circ} I\textsubscript{D} -> L  \ensuremath{\circ} R  \ensuremath{\circ} L -> I\textsubscript{C}  \ensuremath{\circ} L = L
\end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
R = I\textsubscript{D}  \ensuremath{\circ} R -> R  \ensuremath{\circ} L  \ensuremath{\circ} R -> R  \ensuremath{\circ} I\textsubscript{C} = R
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
ε \textsubscript{L d}  \ensuremath{\circ} L η \textsubscript{d} = id \textsubscript{L d}
R ε c  \ensuremath{\circ} η \textsubscript{R c} = id \textsubscript{R c}
\end{Verbatim}
...
extract :: w c -> c
\end{Verbatim}
Here, \code{m} is the (endo-) functor corresponding to \code{R \ensuremath{\circ} L},
and \code{w} is the (endo-) functor corresponding to \code{L \ensuremath{\circ} R}. As
...
\begin{Verbatim}[commandchars=\\\{\}]
C(L d, L d) \ensuremath{\cong} D(d, (R  \ensuremath{\circ} L) d)
\end{Verbatim}
...
element of \code{D(d, (R  \ensuremath{\circ} L) d)} or, inserting the identity
functor \code{I}, a morphism in:

\begin{Verbatim}[commandchars=\\\{\}]
D(I d, (R  \ensuremath{\circ} L) d)
\end{Verbatim}
...
\code{R  \ensuremath{\circ} L} (the naturality condition is easy to verify). This is
...
element of \code{D((R  \ensuremath{\circ} L) d, R c)}.
...
\code{(R  \ensuremath{\circ} L) d}. We get:

\begin{Verbatim}[commandchars=\\\{\}]
φ\textsubscript{f} = R f  \ensuremath{\circ} η\textsubscript{d}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
p = fst  \ensuremath{\circ} m
q = snd  \ensuremath{\circ} m
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
(a\ensuremath{\Rightarrow}b) × a = (L  \ensuremath{\circ} R) b
\end{Verbatim}
