...
write the pair formally as \code{\textless{}a,\ b>},
...
represent the pair \code{\textless{}a,\ b>} in a way
...
the pair \code{\textless{}a,\ b>} to our product object,
...
\code{\textless{}p,\ q>} in \emph{C×C} that goes from
\code{\textless{}c,\ c>} to
\code{\textless{}a,\ b>}; in other words, a morphism
...
\code{\textless{}a,\ b>}. Notice that any functor from
...
The exponential \code{ba}, or the function object \code{a\ensuremath{\Rightarrow}b}, can be
defined using a
...
the function object \code{a\ensuremath{\Rightarrow}b} (or \code{ba}). Again, \code{a} is
