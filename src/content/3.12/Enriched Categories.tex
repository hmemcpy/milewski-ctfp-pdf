...
\arrow[rr, "\alpha_{abc} \otimes \rm{id}_d"]
  & & (a \otimes (b \otimes c)) \otimes d
      \arrow[d, "\alpha_{a(b \otimes c)d}"] \\
(a \otimes b) \otimes (c \otimes d)
\arrow[rd, "\alpha_{ab(c \otimes d)}"]
  & & a \otimes ((b \otimes c) \otimes d)
      \arrow[ld, "\rm{id}_a \otimes \alpha_{bcd}"] \\
  & a \otimes (b \otimes (c \otimes d))
\end{tikzcd}
\end{figure}
...
\begin{tikzcd}[row sep=large]
(a \otimes i) \otimes b
\arrow[dr, "\rho_{a} \otimes \rm{id}_b"']
\arrow[rr, "\alpha_{aib}"]
  & & a \otimes (i \otimes b)
      \arrow[dl, "\rm{id}_a \otimes \lambda_b"] \\
  & a \otimes b
\end{tikzcd}
\end{figure}
...
\arrow[r, "\circ\otimes\rm{id}"]
\arrow[dd, "\alpha"]
  & \cat{C}(b,d) \otimes \cat{C}(a,b)
    \arrow[dr, "\circ"] \\
  & & \cat{C}(a,d) \\
\cat{C}(c,d) \otimes (\cat{C}(b,c) \otimes \cat{C}(a,b))
\arrow[r, "\rm{id}\otimes\circ"]
