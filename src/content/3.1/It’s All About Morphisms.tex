...
naturality square are the mappings of some morphism \code{f} under two
...
names like \code{f} or \code{g}, to distinguish one from another ---
...
there is a morphism \code{h} whose composition (either pre- or post-)
...
\item
  ...
  (the ends of \code{f\ ::\ a\ -\textgreater{}\ b}) to the same
