...
applied a transformation of type \code{a\ -\textgreater{}\ m\ b}
...
\code{a\ -\textgreater{}\ T\ b}. The composition of two such arrows
...
\code{(m\ -\textgreater{}\ m)} represent the elements of the monoid.
