...
\code{w\ a} and the function \code{f\ ::\ w\ a\ -\textgreater{}\ b}.
...
not just apply the function \code{w\ a\ -\textgreater{}\ b} to the
...
produce \code{L\ ∘\ R\ ∘\ L\ ∘\ R}. Making \code{T2} from \code{T}
