...
its Lean counterpart. The Lean code snippets were provided by \urlref{https://github.com/logicalfoundations}{logicalfoundations} team.
...
and \raisebox{-.3mm}{\includegraphics[height=.33cm]{fig/icons/lean.png}} respectively, e.g.:
