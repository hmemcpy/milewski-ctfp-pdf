...
where \texttt{v1} is the speed of light in the air and \texttt{v2} is
...
\includegraphics[width=3.12500in]{images/mortar.jpg}
...
(see, e.g., Tatsuya Hagino's thesis in Bibliography).
...
\tightlist
\item
  Tatsuya Hagino, \href{http://web.sfc.keio.ac.jp/~hagino/thesis.pdf}{A
