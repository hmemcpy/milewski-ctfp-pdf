...
% We shouldn't need the *.svg then. -Jared
\includepdf[scale=0.92]{coverpage.pdf}

\pagebreak

% Extract into a new copywrite.tex file:  From here..... -Jared
\vspace*{\fill}
\thispagestyle{empty}
...
\end{center}
\end{small}
% Extract into a new tex file:  Until here -Jared
...
\chapter*{Acknowledgments} % Missing Label -Jared
\addcontentsline{toc}{chapter}{Acknowledgments}

% Extract into acknowledgments file: From here -Jared
\noindent
...
% Extract into acknowledgments file: To here -Jared
...
\chapter*{Colophon} % Missing Label -Jared
\addcontentsline{toc}{chapter}{Colophon}
% Extract into new file: From here -Jared
...
% Extract into new file: To here -Jared
