...
\newcommand{\trExpression}{표현식}
\newcommand{\trStatement}{문장}
\newcommand{\trSymbolic}{심볼릭}
\newcommand{\trHigherOrderFunction}{고계 함수}
\newcommand{\trArgument}{인자}
\newcommand{\trParameter}{인자}
%
