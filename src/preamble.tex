...
% workaround for incompatibility with lettrine's \LettrineFontHook
% https://tex.stackexchange.com/questions/459834/problem-with-using-allrunes-together-with-lettrine-and-a-custom-lettrinefonthook
\usepackage{etoolbox}
...
\renewcommand{\LettrineFontHook}{\rmfamily\xmdseries\color{DropCapViolet}}
...
\newcommand{\srcsnippet}[3]{
  ...
  \begin{mdframed}
    \inputminted[autogobble,breaklines,escapeinside=||]{#3}{\snippet}
  \end{mdframed}
}
\makeatother
